    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                <div>
                    <h2 class="text-3xl font-extrabold text-green-900 tracking-tight">Moderasi Thread</h2>
                    <p class="text-gray-500 mt-1">Pantau dan bersihkan konten forum yang tidak sesuai ketentuan.</p>
                </div>
                
                {{-- Indikator jumlah thread --}}
            ...
            {{-- Alert notifikasi (Sukses hapus thread) --}}
            @if(session('success'))
